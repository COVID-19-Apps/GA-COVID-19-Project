...
import com.gacovid19project.Adapter.CoronaAdapter;
import com.gacovid19project.Adapter.FAQAdapter;
import com.gacovid19project.Models.Corona;
import com.gacovid19project.Models.FAQ;
import com.gacovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Goa").getJSONObject("districtData");
