...
public class Jsons {
    ...
    String  home_treatment_images, home_treatment_links, toll_numbers, lab_test, donate,
            tweets, faq, epass, tracker, migrant, corona, ga, cbse, vocational_education, go, food;

    public Jsons() {
    }

    public Jsons(String home_treatment_images, String home_treatment_links, String toll_numbers, String lab_test, String donate, String tweets, String faq, String epass, String tracker, String migrant, String corona, String ga, String cbse, String vocational_education, String go, String food) {
